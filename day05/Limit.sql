...
--soru2: musteriler tablosundan id degeri 2 den buyuk olan, ilk 3 veriyi listeleyiniz
select * from musteriler where id>2 limit 3;

-- SORU3: musteriler tablosunda maas'i 20000'den büyük olan, ilk 3 veriyi listeleyiniz
...
--not:Satir atlamak istedigimiz de ofset komutunu kullaniriz.
