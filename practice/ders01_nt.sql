...
insert into ogrenciler values(121,'Ali can','Ankara',70);
...
select isim,ogr_id  from ogrenciler;
...
select isim, sinav_notu from ogrenciler where sinav_notu>75 and sinav_notu<95 ;
--2.yol
