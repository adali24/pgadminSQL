...
alter table personel add column ulke_ismi varchar(50) default 'Turkiye'

--SORU2: personel tablosuna cinsiyet sutunu ekleyiniz, default degeri 'E' olsun
alter table personel add column cinsiyet varchar(50) default 'E'
...
alter table personel drop column tel_no  ,drop column  cocuk_sayisi ;-- ekledigimiz colonlari sildik
